...
insert into population(fauna_id, population, gestation_period) values (1, 5000, 14);
insert into population(fauna_id, population, gestation_period) values (2, 10000, 30);
insert into population(fauna_id, population, gestation_period) values (3, 17000, 40);
insert into population(fauna_id, population, gestation_period) values (4, 20500, 35);
insert into population(fauna_id, population, gestation_period) values (5, 30000, 110);
insert into population(fauna_id, population, gestation_period) values (6, 3000, 80);
insert into population(fauna_id, population, gestation_period) values (7, 2000, 80);
insert into population(fauna_id, population, gestation_period) values (8, 10500, 75);
insert into population(fauna_id, population, gestation_period) values (9, 100, 90);
insert into population(fauna_id, population, gestation_period) values (10, 50000, 7);

select fa.name, po.population, po.gestation_period
from fauna as fa join population as po on fa.id = po.fauna_id;
...
from fauna as join population as po on fa.id = po.fauna_id;

select fa.name Вид, fa.avg_age as "Средняя продолжительность жизни в днях", po.population Популяция
from fauna fa join population po on fa.id = po.fauna_id;